...
public class BookieWriteToJournalTest {
    ...
    @Test
    public void testSmallQueueDeadlock() throws IOException, InterruptedException {
        ServerConfiguration configuration = new ServerConfiguration();
        // XXX: Low queue size if deadlock not happen.
        configuration.setJournalQueueSize(20);
        configuration.setJournalFlushWhenQueueEmpty(true);
        configuration.setJournalBufferedEntriesThreshold(1);
